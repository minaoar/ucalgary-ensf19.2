...
model_name_it = project_home+"output/gender_classifier_vgg_19_it.h5"
model_name_ft = project_home+"output/gender_classifier_vgg_19_ft.h5"
...
train_gen = ImageDataGenerator(**gen_params, preprocessing_function = tf.keras.applications.vgg19.preprocess_input, validation_split=.2)
val_gen = ImageDataGenerator(**gen_params, preprocessing_function = tf.keras.applications.vgg19.preprocess_input, validation_split=.2)
