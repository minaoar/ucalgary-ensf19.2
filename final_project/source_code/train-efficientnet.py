...
model_name_it = project_home+"output/gender_classifier_en_b0_it.h5"
model_name_ft = project_home+"output/gender_classifier_en_b0_ft.h5"
...
train_gen = ImageDataGenerator(**gen_params, preprocessing_function = tf.keras.applications.efficientnet.preprocess_input, validation_split=.2)
val_gen = ImageDataGenerator(**gen_params, preprocessing_function = tf.keras.applications.efficientnet.preprocess_input, validation_split=.2)
