...
model_name_it = project_home+"output/gender_classifier_rn_50_v2_it.h5"
model_name_ft = project_home+"output/gender_classifier_rn_50_v2_ft.h5"
...
train_gen = ImageDataGenerator(**gen_params, preprocessing_function = tf.keras.applications.resnet_v2.preprocess_input, validation_split=.2)
val_gen = ImageDataGenerator(**gen_params, preprocessing_function = tf.keras.applications.resnet_v2.preprocess_input, validation_split=.2)
